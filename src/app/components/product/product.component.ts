...
export class ProductComponent implements OnInit, AfterViewInit {
  ...
  checkExistingCart(userId: string): Observable<boolean> {
    const url = `https://apitripstore.onrender.com/api/tripstore/v1/shopping-carts`;
  ...
  createCart(userId: string): Observable<any> {
    const createUrl = 'https://apitripstore.onrender.com/api/tripstore/v1/shopping-carts';
    const getAllUrl = 'https://apitripstore.onrender.com/api/tripstore/v1/shopping-carts';
  ...
  addToCart(product: any) {
    ...
    if (userId) {
      this.checkExistingCart(userId).subscribe((cartExists: boolean) => {
            ...
            const url = 'https://apitripstore.onrender.com/api/tripstore/v1/cart-items';
